export default function MondelezCaseStudy() {
  return (
    <div className="w-full h-screen bg-[#0F172A]">
      ...
      <div className="h-20 border-b border-slate-700 flex items-center justify-between px-10 bg-[#111827]">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">
            Mondelez International OOH FMCG Strategy
          </h1>
        ...
        <a
          href="/images/case-studies/mondelez.pdf"
          target="_blank"
      ...
      {/* PDF Viewer */}
      <iframe
        src="/images/case-studies/mondelez.pdf#toolbar=1"
        title="Mondelez Case Study"
